...
cv2.createTrackbar("Hue Max","TrackBars",17,179,empty)             #Mit slidern anfangswerte herrausfinden
cv2.createTrackbar("Sat Min","TrackBars",45,255,empty)
cv2.createTrackbar("Sat Max","TrackBars",255,255,empty)
cv2.createTrackbar("Value Min","TrackBars",102,255,empty)
cv2.createTrackbar("Value Max","TrackBars",255,255,empty)

path = 'Recources/lambo.png'
